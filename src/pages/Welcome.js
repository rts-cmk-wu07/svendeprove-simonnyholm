  ...
  return (
    <>
      <div className="relative h-[100vh] bg-splashImage bg-no-repeat bg-cover bg-center z-[80]">
        ...
        <div>
          <p className="absolute top-[45vh] left-[8vw] font-extrabold font-roboto text-[36px] text-transparent uppercase first">
            Landrup
          </p>
        ...
        <div className="w-full absolute h-[20vh] flex justify-center top-[83vh] shadowed">
          <motion.button
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
